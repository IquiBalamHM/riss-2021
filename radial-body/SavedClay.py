...
class DemoRope(App):
    ...
    def Initialize(self):
        ...
        rope.AddParticles(
            self.world.AddParticle(20.0, self.world.hsize.y),
            self.world.AddParticle(40.0, self.world.hsize.y),
            self.world.AddParticle(60.0,self.world.hsize.y),
            self.world.AddParticle(80.0,self.world.hsize.y),
            self.world.AddParticle(100.0,self.world.hsize.y),
            self.world.AddParticle(120.0,self.world.hsize.y),
            self.world.AddParticle(140.0,self.world.hsize.y),
            self.world.AddParticle(160.0,self.world.hsize.y),
            self.world.AddParticle(180.0,self.world.hsize.y),
            self.world.AddParticle(200.0,self.world.hsize.y),
            self.world.AddParticle(220.0,self.world.hsize.y),
            self.world.AddParticle(240.0,self.world.hsize.y),
            self.world.AddParticle(260.0,self.world.hsize.y),
            self.world.AddParticle(280.0,self.world.hsize.y),
            self.world.AddParticle(300.0,self.world.hsize.y),
            self.world.AddParticle(320.0,self.world.hsize.y),
            self.world.AddParticle(340.0,self.world.hsize.y),
            self.world.AddParticle(360.0,self.world.hsize.y),
            self.world.AddParticle(380.0,self.world.hsize.y),
            self.world.AddParticle(400.0,self.world.hsize.y),
            self.world.AddParticle(420.0,self.world.hsize.y),
            self.world.AddParticle(440.0,self.world.hsize.y),
            self.world.AddParticle(460.0,self.world.hsize.y),
            self.world.AddParticle(480.0,self.world.hsize.y),
            self.world.AddParticle(500.0,self.world.hsize.y),
            self.world.AddParticle(520.0,self.world.hsize.y),
            self.world.AddParticle(540.0,self.world.hsize.y),
            self.world.AddParticle(560.0,self.world.hsize.y),
            self.world.AddParticle(580.0,self.world.hsize.y),
            self.world.AddParticle(600.0,self.world.hsize.y),
            self.world.AddParticle(620.0,self.world.hsize.y)
        )
